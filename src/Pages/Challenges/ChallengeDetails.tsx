...
export default function ChallengeDetails() {
	...
	const [error, setErrors] = useState<Partial<ApiErrorResponse>>({});
	...
	return (
		<section className="p-2 lg:p-8">
			...
			>
				...
				{/* PARTICIPATIONS */}
				<div className="flex flex-col gap-6 items-center w-[90%] max-w-[370px] mx-auto md:w-[70%] md:max-w-[600px] lg:max-w-[800px]">
									...
									<div className="flex flex-col items-center mt-2">
										<div className="flex items-center gap-2 mt-1">
											...
											{loadingUser ? (
												...
												<FaHeart
													className={`cursor-pointer text-[18px] ${votes[participation.id] ? "text-red-500" : "text-white"}`}
													onClick={() =>
